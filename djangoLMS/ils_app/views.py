...
from django_jinja_knockout.views import (
    FormDetailView, InlineCreateView, InlineDetailView, InlineCrudView, ListSortingView, BsTabsMixin, PageContextMixin, FoldingPaginationMixin, ContextDataMixin
)

"""
#ContextDataMixin is removed from the above list
