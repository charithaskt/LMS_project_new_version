...
class BorrowersForm(RendererModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'category': ForeignKeyGridWidget(grid_options={
                'pageRoute': 'categories_fk_widget_grid',
            }),
            'department': ForeignKeyGridWidget(grid_options={
                'selectMultipleRows': True,
                'pageRoute': 'departments_fk_widget_grid',
            }),
            'designation': ForeignKeyGridWidget(grid_options={
                'selectMultipleRows': True,
...
class BiblioForm(RendererModelForm):
    ...
    class Meta(RendererModelForm.Meta):
        ...
        exclude = ('timestamp_updated',)
        widgets = {
            'publisher': ForeignKeyGridWidget(grid_options={
                'pageRoute': 'publisher_fk_widget_grid',
            }),
            'language': ForeignKeyGridWidget(grid_options={
                'pageRoute': 'language_fk_widget_grid',
            }),
            'first_author': ForeignKeyGridWidget(grid_options={
                'selectMultipleRows': True,
                'pageRoute': 'authors_fk_widget_grid',
            }),
            'corporateauthor': ForeignKeyGridWidget(grid_options={
                'selectMultipleRows': True,
                'pageRoute': 'corporateauthor_fk_widget_grid',
            }),
            'subject_heading': ForeignKeyGridWidget(grid_options={
...
class ItemsForm(RendererModelForm):
    ...
    class Meta:
        ...
        fields = '__all__'
        widgets = {
            'collectiondepartment': ForeignKeyGridWidget(grid_options={
...
class ReservesForm(RendererModelForm):
    class Meta:
        ...
        fields = '__all__'
        widgets = {
            'borrower': ForeignKeyGridWidget(grid_options={
                'pageRoute': 'borrowers_fk_widget_grid',
...
class HoldForm(RendererModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'biblio': ForeignKeyGridWidget(grid_options={
