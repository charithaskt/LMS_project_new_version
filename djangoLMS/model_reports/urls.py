...
urlpatterns = [
    ...
    #ASE templates
    re_path(r'^ase-home/', TemplateView.as_view(template_name='ASE/main.html'), name='ase-home'),
    re_path(r'^absc_home/', TemplateView.as_view(template_name='ABSC/home.html'), name='absc-home'),
    #patron bulk photos_upload
    re_path(r'^photos-home/', TemplateView.as_view(template_name='photos-home.html'), name='photos-home'),
    #rss feeds
    re_path(r'^photos/', include(('photos.urls', 'photos'), namespace='photos')),
