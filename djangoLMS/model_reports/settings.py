...
CORS_ORIGIN_WHITELIST = (
        'http://localhost:3000', #react app frontend url
        'http://localhost:8000',
)
...
TEMPLATES = [
    ...
    #djk
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'templates'),os.path.join(BASE_DIR,'templates/ASE'),],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#For sending emails out using Postifix Mail Transfer Agemt
EMAIL_USE_TLS = True
...
#For sending emails out directly using django
...
AUTH_LDAP_USER_SEARCH = LDAPSearch(
    'ou=user,dc=iiitslibrary,dc=org',
    ldap.SCOPE_SUBTREE, 
    '(mail=%(user)s)',
)
